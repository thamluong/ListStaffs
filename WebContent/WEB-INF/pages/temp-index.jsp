...
<body>
	<div class='container'>
				...
				<tbody>
					<c:forEach var="staff" items="${listStaff}" varStatus="status">
						<tr>
							...
							<td id='detail_id'><a data-toggle="modal"
								data-target="#myModal_1" class="detail">
									<button type="button" class="btn btn-success">Detail</button>
							</a></td>

							<td id="delete"><button class='delete_button'>Delete</button></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
		...
		<!-- <button type="button" class="btn btn-info btn-lg addstaff">Add</button> -->
		

		<button type="button" class="btn btn-info btn-lg addstaff"
			data-toggle="modal" data-target="#myModal_1">Add</button>
